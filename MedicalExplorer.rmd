...
cycle_period =  Period %>% 
  arrange(desc(Date)) %>% 
  filter(grepl("eriod",Activity)) %>%
  mutate(ValueCol = ifelse(grepl("eavy",Activity),3,2),
         DateCol  = Date)
